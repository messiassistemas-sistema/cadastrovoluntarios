        ...
        <>
            ...
            {!registrationOpen && (
                <div className="max-w-md mx-auto text-center px-4 pt-20 animate-fadeIn">
                    <div className="w-24 h-24 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-6">
                        <i className="fas fa-lock text-slate-400 text-3xl"></i>
                    </div>
                    <h2 className="text-2xl font-bold text-slate-800 mb-4">Inscrições Encerradas</h2>
            ...
            {registrationOpen && step === 'WELCOME' && (
                <div className="max-w-md mx-auto text-center px-4 pt-10 animate-fadeIn">
                    <div className="w-24 h-24 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-6" aria-hidden="true">
                        <i className="fas fa-hands-helping text-indigo-600 text-4xl"></i>
                    </div>
                    <h2 className="text-2xl font-bold text-slate-800 mb-4">Seja bem-vindo(a)</h2>
                    <p className="italic text-slate-600 mb-8">
            ...
            {step === 'BAPTISM' && (
                <StepWrapper title="Etapa 1: Batismo">
                    <p className="mb-6 text-slate-600">Para servir no ministério, é fundamental ter passado pelas águas do batismo.</p>
                    <div className="space-y-4">
                        <button
                            ...
                            className="w-full bg-white border-2 border-slate-200 hover:border-indigo-600 p-4 rounded-xl flex justify-between items-center transition-colors group text-slate-900 focus:ring-2 focus:ring-indigo-500 outline-none"
                        >
                        ...
                        <button
                            ...
                            className="w-full bg-white border-2 border-slate-200 hover:border-red-500 p-4 rounded-xl flex justify-between items-center transition-colors group text-slate-900 focus:ring-2 focus:ring-red-500 outline-none"
                        >
            ...
            {step === 'INTEGRATION_REDIRECT' && (
                <div className="max-w-md mx-auto text-center px-4 pt-4 animate-fadeIn">
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100" role="alert">
                        <i className="fas fa-water text-indigo-500 text-5xl mb-6" aria-hidden="true"></i>
                        <h3 className="text-xl font-bold text-slate-800 mb-4">Próximo Passo: Batismo</h3>
                        <p className="text-slate-600 mb-8">
            ...
            {step === 'PERSONAL_DATA' && (
                <StepWrapper title="Etapa 2: Dados Pessoais">
                    <div className="space-y-4">
                        <div>
                            <label htmlFor="full-name" className="block text-sm font-semibold text-slate-700 mb-1">Nome Completo *</label>
                        ...
                        <div>
                            <label htmlFor="phone" className="block text-sm font-semibold text-slate-700 mb-1">Telefone (WhatsApp) *</label>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label htmlFor="birth-date" className="block text-sm font-semibold text-slate-700 mb-1">Nascimento *</label>
                            ...
                            <div>
                                <label htmlFor="marital-status" className="block text-sm font-semibold text-slate-700 mb-1">Estado Civil</label>
            ...
            {step === 'RELATIONSHIP' && (
                <StepWrapper title="Relacionamento">
                    <div className="space-y-4">
                        <p id="relationship-label" className="text-sm text-slate-600">Você está namorando atualmente?</p>
                        <div className="flex gap-4" role="radiogroup" aria-labelledby="relationship-label">
                            <button
                                ...
                                className={`flex-1 p-4 rounded-xl border-2 transition-all focus:ring-2 focus:ring-indigo-500 outline-none ${formData.estaNamorando ? 'border-indigo-600 bg-indigo-50 text-indigo-700 font-bold' : 'border-slate-200 bg-white text-slate-600'}`}
                            >
                                Sim
                            </button>
                            <button
                        ...
                        {formData.estaNamorando && (
                            <div className="mt-4 animate-fadeIn">
                                <label htmlFor="partner-religion" className="block text-sm font-semibold text-slate-700 mb-1">Religião do(a) namorado(a) *</label>
            ...
            {step === 'COMMITMENTS' && (
                <StepWrapper title="Etapa 3: Compromissos">
                    <div className="space-y-6">
                        <p className="text-slate-600 text-sm">Para caminhar com a MVP, precisamos que você esteja alinhado com nossos princípios.</p>
                        ...
                        <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-800 text-sm">Princípios Bíblicos</h4>
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className={`flex-1 py-3 rounded-xl border transition-all text-xs font-bold uppercase tracking-wider ${formData.aceitaPrincipios ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-slate-500 border-slate-300 hover:border-indigo-400'}`}
                                >
                                    <i className="fas fa-check mr-2"></i> Sim
                                </button>
                                <button
                                    onClick={() => updateForm({ aceitaPrincipios: false })}
                                    className={`flex-1 py-3 rounded-xl border transition-all text-xs font-bold uppercase tracking-wider ${!formData.aceitaPrincipios && formData.aceitaPrincipios !== undefined ? 'bg-slate-800 text-white border-slate-800' : 'bg-white text-slate-500 border-slate-300 hover:border-slate-800'}`}
                                >
                                    Não
                                </button>
                            </div>
                        ...
                        <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200">
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-800 text-sm">Escola do Reino</h4>
                                    <p className="text-xs text-slate-500 mt-1">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className={`flex-1 py-3 rounded-xl border transition-all text-xs font-bold uppercase tracking-wider ${formData.escolaReino ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-white text-slate-500 border-slate-300 hover:border-indigo-400'}`}
                                >
                                    <i className="fas fa-check mr-2"></i> Sim
                                </button>
                                <button
                                    onClick={() => updateForm({ escolaReino: false })}
                                    className={`flex-1 py-3 rounded-xl border transition-all text-xs font-bold uppercase tracking-wider ${!formData.escolaReino && formData.escolaReino !== undefined ? 'bg-slate-800 text-white border-slate-800' : 'bg-white text-slate-500 border-slate-300 hover:border-slate-800'}`}
                                >
                                    Pendente
                                </button>
                            </div>
            ...
            {step === 'CONFIDENTIAL' && (
                <StepWrapper title="Etapa 4: Vida Pessoal">
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 mb-3">Possui algum vício atualmente?</label>
                            <div className="grid grid-cols-1 gap-3">
                                {(['Não', 'Sim – bebida alcoólica', 'Sim – cigarro', 'Sim – outro'] as AddictionType[]).map((opt) => (
                                    <button
                                        key={opt}
                                        onClick={() => updateForm({ possuiVicios: opt })}
                                        className={`text-left p-3 rounded-xl border-2 transition-all text-sm font-medium outline-none focus:ring-2 focus:ring-indigo-500 ${formData.possuiVicios === opt ? 'border-indigo-600 bg-indigo-50 text-indigo-700' : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300'}`}
                                    >
                                        {opt}
                                    </button>
                                ))}
                        ...
                        {formData.possuiVicios === 'Sim – outro' && (
                            <div className="animate-fadeIn">
                                <label htmlFor="addiction-desc" className="block text-sm font-semibold text-slate-700 mb-1">Qual?</label>
            ...
            {step === 'TRAINING' && (
                <StepWrapper title="Treinamento">
                    <div className="space-y-4">
                        <p className="text-slate-600 text-sm mb-4">A excelência no serviço exige preparo. Temos treinamentos específicos para cada área.</p>
                        ...
                        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 text-center mb-6">
                            ...
                            <h4 className="font-bold text-slate-800 mb-2">Disponibilidade para Treinamento</h4>
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className={`w-full p-4 rounded-xl border-2 transition-all flex items-center justify-between group outline-none focus:ring-2 focus:ring-indigo-500 ${formData.disponivelTreinamento ? 'border-indigo-600 bg-indigo-50 text-indigo-700 shadow-sm' : 'border-slate-200 bg-white text-slate-600 hover:border-indigo-300'}`}
                            >
                                <div className="flex items-center gap-3">
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center border transition-colors ${formData.disponivelTreinamento ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-white border-slate-300'}`}>
                            ...
                            <button
                                ...
                                className={`w-full p-4 rounded-xl border-2 transition-all flex items-center justify-between group outline-none focus:ring-2 focus:ring-indigo-500 ${!formData.disponivelTreinamento ? 'border-indigo-600 bg-indigo-50 text-indigo-700 shadow-sm' : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300'}`}
                            >
                                <div className="flex items-center gap-3">
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center border transition-colors ${!formData.disponivelTreinamento ? 'bg-indigo-600 border-indigo-600 text-white' : 'bg-white border-slate-300'}`}>
            ...
            {step === 'MINISTRY_IDENTIFICATION' && (
                <StepWrapper title="Área de Identificação">
                    <div className="space-y-4">
                        <p className="text-slate-600 text-sm mb-4">Em qual área você sente que seus dons seriam melhor utilizados?</p>
                        <div className="grid grid-cols-1 gap-2 max-h-60 overflow-y-auto pr-2 custom-scrollbar">
                            {ministries.map(min => (
                                <button
                                    key={min}
                                    onClick={() => updateForm({ ministerioIdentificacao: min })}
                                    className={`text-left p-3 rounded-xl border-2 transition-all text-sm font-bold flex justify-between items-center outline-none focus:ring-2 focus:ring-indigo-500 ${formData.ministerioIdentificacao === min ? 'border-indigo-600 bg-indigo-50 text-indigo-700 shadow-sm' : 'border-slate-100 bg-white text-slate-600 hover:border-slate-300'}`}
                                >
                                    {min}
                                    {formData.ministerioIdentificacao === min && <i className="fas fa-check text-indigo-600"></i>}
                                </button>
                            ))}
                        </div>
            ...
            {step === 'REVIEW' && (
                <div className="max-w-md mx-auto px-4 pb-20 animate-fadeIn">
                    <h2 className="text-2xl font-bold text-slate-800 mb-6 text-center">Revisão</h2>
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-6">
                        <div className="text-center pb-6 border-b border-slate-100">
                            <div className="w-20 h-20 bg-indigo-50 rounded-full flex items-center justify-center mx-auto mb-4">
                                <i className="fas fa-user-check text-indigo-500 text-3xl"></i>
                            </div>
                            <h3 className="font-bold text-slate-800 text-lg">{formData.nomeCompleto}</h3>
                            <p className="text-slate-500 text-sm">{formData.telefone}</p>
                        </div>

                        <div className="space-y-3 text-sm">
                            <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg">
                                <span className="text-slate-500">Batizado?</span>
                                <span className={`font-bold ${formData.batizado ? 'text-green-600' : 'text-red-500'}`}>{formData.batizado ? 'Sim' : 'Não'}</span>
                            </div>
                            <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg">
                                <span className="text-slate-500">Escola do Reino?</span>
                                <span className={`font-bold ${formData.escolaReino ? 'text-green-600' : 'text-amber-500'}`}>{formData.escolaReino ? 'Sim/Disposto' : 'Pendente'}</span>
                            </div>
                            <div className="flex justify-between items-center bg-slate-50 p-3 rounded-lg">
                                <span className="text-slate-500">Área de Interesse</span>
                                <span className="font-bold text-indigo-600">{formData.ministerioIdentificacao}</span>
                            </div>
                        </div>

                        <div className="pt-4 flex gap-3">
                            <button onClick={handleBack} className="flex-1 bg-white border border-slate-300 py-4 rounded-xl font-medium text-slate-600 focus:ring-2 focus:ring-slate-300 outline-none">Editar</button>
                            <button
            ...
            {step === 'SUCCESS' && (
                <div className="max-w-md mx-auto text-center px-4 pt-10 animate-fadeIn">
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl mb-8 text-left border border-slate-200">
                        <h4 className="font-bold text-slate-700 mb-2 text-sm uppercase tracking-wider">Próximos Passos:</h4>
                        <ul className="space-y-3 text-sm text-slate-600">
                            <li className="flex items-start gap-3">
                                <i className="fas fa-search text-indigo-500 mt-1"></i>
                            ...
                            <li className="flex items-start gap-3">
                                <i className="fas fa-chalkboard text-amber-500 mt-1"></i>
